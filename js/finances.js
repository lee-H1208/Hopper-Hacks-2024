...
const leftToSpendElement = document.getElementById("left-to-spend"); 
...
function renderExpenses() { 
    ...
    leftToSpendElement.textContent = 
		leftToSpend.toFixed(2); 

    leftToSpendElement.innerHTMl() = "45"; 
...
// Add event listeners 
expenseForm.addEventListener("addButton", addExpense); 
